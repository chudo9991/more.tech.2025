...
export type BoxShadowValue = keyof typeof designTokens.boxShadow;
export type BreakpointName = keyof typeof designTokens.breakpoints;
export type ZIndexValue = keyof typeof designTokens.zIndex;