...
{{
    ...
    "experience_analysis": {{
        ...
        "extracted_keywords": ["ключевое слово 1", "ключевое слово 2", "навык 1", "технология 1"]
    }},
    "skills_analysis": {{
        ...
        "extracted_keywords": ["навык 1", "технология 1", "инструмент 1", "язык программирования 1"]
    }},
    "education_analysis": {{
        ...
        "extracted_keywords": ["университет", "специальность", "курс", "сертификат"]
    }},
    "overall_assessment": {{
